...
speedtest-locked: speedtest.c Makefile
	gcc -Wall -pthread -lrt -lssl -lcrypto -DLOCK_STATIC_EVP_MD_CTX -o speedtest-locked speedtest.c
speedtest-copied: speedtest.c Makefile
	gcc -Wall -pthread -lrt -lssl -lcrypto -o speedtest-copied speedtest.c
clean:
